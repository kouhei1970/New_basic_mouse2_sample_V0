...
void mode7(void)
{
	...
	straight(50, -100, 0, 2, 0);	//ケツタッチ
	set_wall_gain(5);
	straight(H_SECTION + 40, 500, 500, 2, 1);

	while(1){
		if(wall_ls == 0){							//左壁なし
			straight(H_SECTION, 500, 0, 2, 1);
			turn(90);
			straight(H_SECTION, 500, 500, 2, 1);
		}
		else if((wall_lf == 0) && (wall_rf == 0)){	//前壁なし
			straight(SECTION, 500, 500, 2, 1);
		}
